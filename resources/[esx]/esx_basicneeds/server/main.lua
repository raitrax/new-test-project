...
--BAHAMA--
ESX.RegisterUsableItem('bahama0', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)
   xPlayer.setJob('bahama', '0')
end)
ESX.RegisterUsableItem('bahama1', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)
   xPlayer.setJob('bahama', '1')
end)
ESX.RegisterUsableItem('bahama2', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)
   xPlayer.setJob('bahama', '2')
end)
ESX.RegisterUsableItem('bahama3', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)
   xPlayer.setJob('bahama', '3')
end)