...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			...
			{ x = 1857.05, y = 3689.28, z = 33.26 },
			{ x = -449.43, y = 6016.53, z = 30.71 }
		},

		Armories = {
			{ x = 451.699, y = -980.356, z = 29.689 },
			{ x = 1851.30, y = 3683.80, z = 33.26 },
			{ x = -443.01, y = 6012.56, z = 30.71 }
		...
		Vehicles = {
			...
			{
				Spawner    = { x = 1867.41, y = 3694.17, z = 32.65 },
				SpawnPoint = { x = 1876.09, y = 3679.36, z = 33.65 },
				Heading    = 90.0
			},
			{
				Spawner    = { x = -446.46, y = 5990.06, z = 30.34 },
				SpawnPoint = { x = -464.37, y = 6018.79, z = 31.34 },
				Heading    = 90.0
			}
		},
		...
		VehicleDeleters = {
			...
			{ x = 1876.06, y = 3695.24, z = 32.41 },
			{ x = 1876.06, y = 3695.24, z = 32.41 },
			{ x = -465.16, y = 6042.05, z = 30.34 }
		},

		BossActions = {
			{ x = 448.417, y = -973.208, z = 29.689 },
			{ x = 1852.89, y = 3689.55, z = 33.26 },
			{ x = -448.64, y = 6012.17, z = 30.71 }
		},
